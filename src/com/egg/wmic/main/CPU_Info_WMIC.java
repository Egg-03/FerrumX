...
class CPU{
	...
	private static String getValues(String WMIC_Attribute) throws IOException {
		...
		br.close();
		return actualName.substring(actualName.indexOf("=")+1);
	}
...
public class CPU_Info_WMIC {

	public static void main(String[] args) throws IOException {
		System.out.println(CPU.getName());
		System.out.println(CPU.getCores());
		System.out.println(CPU.getThreads());
		System.out.println(CPU.getManufacturer());
		System.out.println(CPU.getAddressWidth()+" bit");
		System.out.println(CPU.getL2CacheSize()+" KB");
		System.out.println(CPU.getL3CacheSize()+" KB");
		System.out.println(CPU.getCurrentClockSpeed()+" MHz");
		System.out.println(CPU.getMaxClockSpeed()+" MHz");
