...
public class Win32_DiskDrive {
	...
	/**
	 * Fetches a list of Disk Drives based on their DeviceID property
	 * This method internally calls {@link com.ferrumx.formatter.cim.CIM_ML#get(String, String)} and passes the classname and the attributes mentioned in the class description as parameters
	...
	/**
	 * Fetches the Disk Details whose IDs were fetched using the {@link Win32_DiskDrive#getDriveID()} method
	 * @param driveID this parameter takes one Drive ID at a time from the drive ID list
	 * @return a {@link java.util.Map} of Drive Details which contain the attributes mentioned in the class description, as a key-value pair
