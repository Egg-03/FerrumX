...
public class Win32_NetworkAdapter {
	 ...
	 * @throws IOException re-throws the exception thrown by {@link com.ferrumx.formatter.cim.CIM_ML#getIDWhere(String, String, String, String)} when there are I/O Errors during streaming of data from and to Powershell and other generated files
	 * @throws IndexOutOfBoundsException re-throws the exception thrown by {@link com.ferrumx.formatter.cim.CIM_ML#getIDWhere(String, String, String, String)} when there is a parsing error of data fetched from Windows Powershell
	 */
	 ...
	 * @param deviceID the network adapter ID fetched from {@link Win32_NetworkAdapter#getDeviceIDList()}
	 * @return a {@link java.util.Map} of the properties and their values mentioned in the class description
